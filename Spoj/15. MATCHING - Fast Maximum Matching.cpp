/*
	...
	Carnet: 1710303
	Nick: jmlt_undercode
	Problema: SPOJ 15. MATCHING - Fast Maximum Matching

	** Idea General para el problema: **
	
	Para solventar este problema se estudia y analiza el algoritmo de Hopcroft-Karp
	descrito en el paper a continuacion que sirve para determinar el la cantidad
	maxima de matchs en un grafo bipartito.

	https://web.eecs.umich.edu/~pettie/matching/Hopcroft-Karp-bipartite-matching.pdf
	
	Adicional para una implementacion un tanto diferente se analiza el algoritmo mediante
	...
	** Actualizacion de Libreria/Class: **
	...
	1. Se agregan tres funciones relacionas con el algoritmo de Hopcroft-Karp:
		- DFS_HK()
		- BFS_HK()
		- Hopcroft_Karp()
	2. Se agrega la funcion clean_visit() para resetear la variable visit de la estructura 
	NODE del grado.
...
const int MaxN = 50005;		// Numero maximo de nodos en el conjunto N.
const int MaxM = 50005;		// Numero maximo de nodos en el conjunto M.
const int MaxP = 150005;	// Numero maximo de arcos en el grafo.
int N, M, P;			// Numero de nodos del conjunto A, nodos del conjunto B y arcos.
